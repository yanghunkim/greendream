...
<script src="/resources/js/L_merBer.js"></script>
...
<form action="member12" method="post">
	...
	<div id="sectioncontainer02" class="containerbox">
		...
		<div id="contanierClickbtnbox02">
			<div class="email_auth">
				<h4>&nbsp이메일 :</h4>
				<input type="text"
					placeholder="이메일형식으로 입력해주세요(ex: hong1234@gmail.com)" name="email"
			...
			<div>
				...
				<input type="button" id="check" value="번호 확인"> <input
					type="button" name="next02" id="next02" disabled='disabled'
					value="다음">
			</div>
		</div>
	</div>
			...
			<div id="contanierClickbtnbox03">
				<div>
					...
					<input type="text" name="id" id="id" maxlength="20"
						placeholder="영문소대문자,숫자조합 (8~20자)" maxlength="20"
						onblur="validId()"> <br>
					<label id="lbId"></label><br><input type="button" name="checkId"
						id="checkId" value="중복확인"> <br>
					<!-- </form> -->
					<input type="button" name="next03" id="next03" disabled='disabled'
						value="다음">
				</div>
			</div>
			<!-- </form> -->
			...
			<div id="p">
				...
				<div id="pws">
					<input type="password" name="pw" id="pw"
						...
						onKeyUp="validPw()"> <input type="checkbox" value="표시/숨김"
						onclick="pwe()">
				</div>
				<br> <label id="lbPw"></label>
			</div>
			<div id="kp">
				<h4>비밀번호 확인</h4>
				<input type="password" name="pwc" id="pwc" placeholder="비밀번호 재입력"
					maxlength="20" onKeyUp="validPwc()"> <input type="checkbox"
					id="change" value="표시/숨김" onclick="pwce()"> <br> <label
					id="lbPwc" onblur="ext()"></label>
			</div>
			<input type="button" name="next04" id="next04" disabled='disabled'
				value="다음">
	...
	<div id="sectioncontainer05" class="containerbox">
		...
		<div id="contanierClickbtnbox05">
			...
			<label id="lbPPhone"></label> <input type="button" name="next05"
				id="next05" disabled='disabled' value="다음">
			<!-- </form> -->
		</div>
	</div>
		...
		<div id="contanierClickbtnbox06">
			...
			<div onmousemove="etc()" onkeydown="etc2()" id="section06-box">
				...
				<input type="text" name="name" id="name"
					...
					onKeyUp="validName()"> <br> <label id="lbName"></label><br>
				<div>
				...
				<div class="info" id="info__birth">
					...
					</select><br> <label id="lbBir"></label>
				</div>
				<br>
				<div>
				...
				<div id="boxgender">
					<label><input type="radio" name="gender" id="male"
						value="남">남자</label> <label><input type="radio"
						name="gender" id="female" value="여">여자</label> <label><input
						type="radio" name="gender" id="nogender" value="중">선택안함</label>
				</div>
